...
from datetime import date, DateRange, datetime
...
class RatingForm(FlaskForm):
    ...
    date_read = DateField('Date read format:yyyy-m-d', validators = [DateRange(min=datetime(1999, 1, 1),max=datetime(date.totay()))])
